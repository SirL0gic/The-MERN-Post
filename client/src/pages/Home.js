      ...
      <Row>
        <Col lg={8} className="news-container">
          <div className="news-area">
            ...
            <br></br>
            <br></br>
            <NewsCard title="Russia pauses grain deal after Ukraine strikes warships in Crimea" link="/sports" height="460px" author="Mary Ilyushina" mini="Russia suspended its participation in the U.N.-brokered deal that allowed Ukraine to export its grain and other agricultural products from Black Sea ports after claiming that Kyiv used the corridor to attack Kremlin ships, reigniting concerns about global food insecurity." image="https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/KNNJEFH4DFY3QFHPLNPWL7LFAE.jpg&w=916" />
            <br></br>
            <br></br>
